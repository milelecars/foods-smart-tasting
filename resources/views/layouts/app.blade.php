...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="px-6 w-full">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-1">
                    @auth
                        <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-md transition-colors">
    ...
    <?php 
        ...
        $isAdminView = $currentUser && ($currentUser->isAdmin() || $currentUser->hasMultipleRoles());
    ?>
