...
<div class="">
    <div class="flex flex-col items-center justify-center gap-10 min-h-screen py-12 max-w-2xl mx-auto px-4 text-center">
        ...
        <div class="space-y-4">
            <a href="{{ url('/') }}" 
               class="inline-flex items-center justify-center w-full md:w-auto bg-milele-green text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
