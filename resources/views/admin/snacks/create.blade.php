...
<div class="p-20 space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Snack</h1>
            <p class="text-gray-600">Add a new snack product</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('admin.snacks.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" 
                              ...
                              placeholder="Describe this snack...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Upload an image for this snack (optional)</p>
                    @error('image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
